...
if __name__ == '__main__':
    ...
    # data arguments
    # parser.add_argument('--train_root', type=str, default='datasets/ml-1m_Tmember_train')
    # parser.add_argument('--test_root', type=str, default='datasets/ml-1m_Tmember_test')
    parser.add_argument('--train_root', type=str, default='datasets/beauty_Tmember_train')
    parser.add_argument('--test_root', type=str, default='datasets/beauty_Tmember_test')
