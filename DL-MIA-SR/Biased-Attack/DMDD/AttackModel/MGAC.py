...
pathT = "../../../Recommender/caser_pytorch-master/datasets"
...
if not os.path.exists(DataDir):
    os.mkdir(DataDir)
ShadowDataset = open("../AttackData/trainForClassifier_MGAC.txt", 'w')
TargetDataset = open("../AttackData/testForClassifier_MGAC.txt", 'w')
