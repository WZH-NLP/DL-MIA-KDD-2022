...
if __name__ == '__main__':
    ...
    # data arguments
    # parser.add_argument('--train_root', type=str, default='datasets/ml-1m_Smember_train')
    # parser.add_argument('--test_root', type=str, default='datasets/ml-1m_Smember_test')
    parser.add_argument('--train_root', type=str, default='datasets/beauty_Smember_train')
    parser.add_argument('--test_root', type=str, default='datasets/beauty_Smember_test')
