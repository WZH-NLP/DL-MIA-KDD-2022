...
if not os.path.exists(DataDir):
    os.mkdir(DataDir)
ShadowDataset = open("../AttackData/trainForClassifier_MCAG1.txt", 'w')
TargetDataset = open("../AttackData/testForClassifier_MCAG1.txt", 'w')
...
optimizer = torch.optim.SGD(mlp.parameters(), lr=0.02, momentum=0.7)
