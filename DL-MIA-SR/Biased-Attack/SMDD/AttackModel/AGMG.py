...
path = "../../../Dataset/data/processed_amazon/"
itemDict = {}
...
path1 = "../../../Dataset/data/processed_movielens/"
itemDict1 = {}
...
if not os.path.exists(DataDir):
    os.mkdir(DataDir)
ShadowDataset = open("../AttackData/trainForClassifier_AGMG.txt", 'w')
TargetDataset = open("../AttackData/testForClassifier_AGMG.txt", 'w')
