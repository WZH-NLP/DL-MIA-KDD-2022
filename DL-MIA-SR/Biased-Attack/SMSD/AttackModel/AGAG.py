...
pathS = "../../../Recommender/GRU4REC-pytorch-master/data"
pathT = pathS
...
if not os.path.exists(DataDir):
    os.mkdir(DataDir)
ShadowDataset = open("../AttackData/trainForClassifier_AGAG.txt", 'w')
TargetDataset = open("../AttackData/testForClassifier_AGAG.txt", 'w')
...
np.random.shuffle(vector_target)
np.random.set_state(state1)
np.random.shuffle(label_target)
