...
fr_shadow = open(path+"/ml-1m/movielens_topk_target_popular_lfm", 'r') # recommend for shadow
fr_target = open(path+"/amazon/amazon_music_topk_shadow_popular_itembase", 'r') # recommend for target
...
if not os.path.exists(DataDir):
    os.mkdir(DataDir)
ShadowDataset = open("../AttackData/trainForClassifier_MLAI.txt", 'w')
TargetDataset = open("../AttackData/testForClassifier_MLAI.txt", 'w')
for i in range(num_shadow):
